export enum SpeakerName {
  ...
  MikaelBrevikAndStianMøllersen = "Mikael Brevik & Stian Møllersen",
  SvanhildEgge = "Svanhild Egge",
  OddMortenSveås = "Odd Morten Sveås",
  LesehestenUtvikling = "Lesehesten Utvikling",
  Chiruto = "Chiruto",
  ...
  DavidDeLeon = "David De Léon",
  AndreaHvattum = "Andrea Hvattum",
  KirstiStrømstad = "Kirsti Strømstad",
  VeraHayeBjerga = "Vera Haye Bjerga",
  NinjaWidenAndChristofferJohannesson = "Ninja Widén & Christoffer Johannesson",
