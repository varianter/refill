import { z } from 'zod';
import { a as apiContextRoutesSymbol, b as shouldAppendForwardSlash, A as ACTION_API_CONTEXT_SYMBOL, h as hasContentType, f as formContentTypes, i as isActionAPIContext } from './index_CGib1MW2.mjs';
import { A as AstroError, a as ActionNotFoundError, b as ActionCalledFromServerError } from './astro/server_ClgZUokg.mjs';
import { r as removeTrailingForwardSlash } from './path_CVKLlyuj.mjs';
import { A as ActionError, s as serializeActionResult, d as deserializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, c as callSafely, e as ActionInputError } from './astro-designed-error-pages_4x2vINuE.mjs';

async function getAction(path) {
  const pathKeys = path.split(".").map((key) => decodeURIComponent(key));
  let { server: actionLookup } = await import('./_astro_internal-actions_Bh_fKfyK.mjs');
